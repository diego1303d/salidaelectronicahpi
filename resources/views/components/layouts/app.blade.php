...
<head>
    ...
    <!-- Fuente Quicksand (la redondeada del diseño) -->
...
<body class="bg-surface dark:bg-gray-950 text-gray-800 dark:text-gray-200 antialiased" x-data="{
    ...
    <!-- Contenedor principal: sidebar a toda la altura + columna derecha -->
                ...
                <div class="p-6 md:p-8">
                    ...
                    @session('status')
                        <div x-data="{ showStatusMessage: true }" x-show="showStatusMessage"
                            ...
                            class="mb-6 bg-green-50 dark:bg-green-900 border-l-4 border-gold p-4 rounded-md">
                            <div class="flex items-center">
                                <div class="flex-shrink-0">
                                    <svg class="h-5 w-5 text-brand dark:text-green-400"
                                ...
                                <div class="ml-3">
                                    <p class="text-sm text-brand dark:text-green-200 font-medium">{{ session('status') }}</p>
                                </div>
                                <div class="ml-auto pl-3">
                                    <div class="-mx-1.5 -my-1.5">
                                        <button @click="showStatusMessage = false"
                                            class="inline-flex rounded-md p-1.5 text-brand dark:text-green-400 hover:bg-green-100 dark:hover:bg-green-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gold">
