                ...
                <div
                    ...
                    <div class="p-6">
                        ...
                        <form class="max-w-md mb-10" action="{{ route('settings.password.update') }}" method="POST">
                            ...
                            @method('PUT')
                            <div class="mb-4">
                                <x-forms.input label="Contraseña Actual" name="current_password" type="password" />
                            </div>

                            <div class="mb-6">
                                <x-forms.input label="Nueva Contaseña" name="password" type="password" />
                            </div>

                            <div class="mb-6">
                                <x-forms.input label="Confirmar Contraseña" name="password_confirmation" type="password" />
                            </div>

                            <div>
                                <x-button type="primary">{{ __('Actualizar Contraseña') }}</x-button>
                            </div>
                        </form>
                    </div>
                </div>
